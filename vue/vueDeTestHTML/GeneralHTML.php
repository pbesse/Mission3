...
class GeneralHTML {
    ...
    public function afficheIndex(){
        ...
        ?>     
            <a href="do.php?action=afficheCheval"> Visualiser les chevaux</a><BR/>
            <a href="do.php?action=afficheFormInsereCheval"> Insérer un cheval</a><BR/>        
            <a href="do.php?action=afficheFormModifieCheval"> Modifier un cheval</a><BR/>
            <a href="do.php?action=afficheFormSupprimeCheval"> Supprimer un cheval</a><BR/>
